...
- [Code and contributions part of the project](#code-and-contributions-part-of-the-project)
...
- **AshAvalanche/ash-rs:** [branch `avalanche-warp-navigator`](https://github.com/AshAvalanche/ash-rs/tree/avalanche-warp-navigator)
- **AshAvalanche/ansible-avalanche-getting-started:** [branch `avalanche-warp-navigator`](https://github.com/AshAvalanche/ansible-avalanche-getting-started/tree/avalanche-warp-navigator)

When developing the Navigator feature, we contributed to Subnet-EVM:

- [Subnet-EVM Warp messages: message encoding in SendWarpMessage event logs](https://github.com/ava-labs/subnet-evm/discussions/794) (discussion)
- [Cannot aggregate Warp message signatures with `warp_getAggregateSignature`](https://github.com/ava-labs/subnet-evm/issues/806) (issue)
